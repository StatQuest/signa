...
### 1️⃣ Install Docker (Linux/Ubuntu & WSL2 on Windows 11)  
Run the following command to install **Docker, Buildx, and Compose** on **Ubuntu/Linux** (including WSL2 on Windows 11):  
